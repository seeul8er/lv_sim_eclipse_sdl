...
void update_print_job_status_ui() {
    // DEBUG
    reprap_job_percent = 99;
    reprap_job_first_layer_height = 0.25;
    reprap_job_layer_height = 0.2;
    reprap_job_height = 45;
    reprap_job_duration = 8423;
    reprap_job_time_sim = 45135;
    reprap_job_curr_layer = 98;
    ...
    strcpy(current_job_name, "Test_Gcode_file.gcode");
...
void draw_jobstatus(lv_obj_t *parent_screen) {
    ...
    style_label_job_filename.text.color = LV_COLOR_WHITE;
    ...
    lv_label_set_long_mode(label_job_filename, LV_LABEL_LONG_SROLL_CIRC);
