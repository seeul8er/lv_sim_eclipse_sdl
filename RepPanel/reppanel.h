...
#define MAX_NUM_ELEM_DIR    64      // Max number of elements per directory that can be listed
#define REPPANEL_RRF_MAX_AXES   5

#define MAX_LEN_FILENAME    128
#define MAX_LEN_DIRNAME     1024
...
file_tree_elem_t reprap_dir_elem[MAX_NUM_ELEM_DIR];  // Array used for buffering directory listings like macros/jobs
